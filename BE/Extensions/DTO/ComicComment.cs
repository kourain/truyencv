...
public static partial class Extensions
{
	...
	public static ComicComment ToEntity(this CreateComicCommentRequest request)
	{
		return new ComicComment
		{
			...
			comic_chapter_id = request.comic_chapter_id,
	...
	public static ComicCommentResponse ToRespDTO(this ComicComment commentEntity)
	{
		...
		{
			id = commentEntity.id,
			comic_id = commentEntity.comic_id,
			comic_chapter_id = commentEntity.comic_chapter_id,
			user_id = commentEntity.user_id,
			comment = commentEntity.comment,
			like = commentEntity.like,
			reply_id = commentEntity.reply_id,
	...
	{
		commentEntity.comic_id = request.comic_id;
		commentEntity.comic_chapter_id = request.comic_chapter_id;
		commentEntity.user_id = request.user_id;
		commentEntity.comment = request.comment;
		commentEntity.like = request.like;
		commentEntity.reply_id = request.reply_id;
