...
namespace TruyenCV.Migrations
{
    ...
    [Migration("20251126102109_UpdateRecommendConstraintToPerComic")]
    partial class UpdateRecommendConstraintToPerComic
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TruyenCV.Models.Comic", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("search_vector"), "ivfflat");
            ...
            modelBuilder.Entity("TruyenCV.Models.UserComicRecommend", b =>
                {
                    ...
                    b.HasIndex("user_id", "comic_id", "month", "year")
                        .IsUnique();
