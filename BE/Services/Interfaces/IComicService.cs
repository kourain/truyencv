...
public interface IComicService
{
	...
	Task<IEnumerable<SearchComicResponse>> SearchComicsAsync(string keyword, int limit = EmbeddingDefaults.MaxResults, double minScore = EmbeddingDefaults.MinScore);
