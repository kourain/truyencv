...
public class ComicDetailResponse
{
	...
	public IReadOnlyList<ComicDetailChapterResponse> latest_chapters { get; set; } = Array.Empty<ComicDetailChapterResponse>();
	public ComicDetailAdvertisementsResponse advertisements { get; set; } = new();
	public string introduction { get; set; } = string.Empty;
	public IReadOnlyList<ComicDetailRelatedComicResponse> related_by_author { get; set; } = Array.Empty<ComicDetailRelatedComicResponse>();
	public IReadOnlyList<ComicDetailReviewResponse> reviews { get; set; } = Array.Empty<ComicDetailReviewResponse>();
	public IReadOnlyList<ComicDetailDiscussionResponse> discussions { get; set; } = Array.Empty<ComicDetailDiscussionResponse>();
